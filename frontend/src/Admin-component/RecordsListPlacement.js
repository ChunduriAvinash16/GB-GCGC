              ...
              <td>
                ...
                <td>
                    <Tooltip title="Edit" placement="left">
                        <Link to={"/editplacement/"+this.props.obj.sno} ><FontAwesomeIcon icon={faEdit} className="ml-2 p-1 fa-lg" style={{backgroundColor:'#2A324B',color:'white',fontSize:'20',borderRadius:'10'}}/></Link>
                    </Tooltip>
